...
const Workshop = () => {
  ...
  const statusColor = (s: string) => {
    const c: Record<string, string> = {
      ...
      pending_parts: "bg-purple-500/10 text-purple-600",
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr><td colSpan={6} className="text-center py-8 text-muted-foreground">No job cards found.</td></tr>
                ) : (
                  filtered.map((jc, i) => (
                    <motion.tr
                      key={jc.id}
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span className={`text-xs font-medium px-2 py-0.5 rounded-sm ${statusColor(jc.status)}`}>
