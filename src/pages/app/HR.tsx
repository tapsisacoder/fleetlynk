      ...
      <div className="flex-1 overflow-auto p-6">
                    ...
                    filtered.map((emp, i) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          {emp.is_driver && <span className="text-xs font-medium px-2 py-0.5 rounded-sm bg-blue-500/10 text-blue-600">Driver</span>}
                        </td>
                      </motion.tr>
                    ))
                  )}
        ...
        {tab === "payroll" && (
          <div className="bg-card border border-border p-8 text-center text-muted-foreground text-sm">
            Payroll periods and entries will appear here.
          </div>
        )}

        {tab === "disciplinary" && (
          <div className="bg-card border border-border p-8 text-center text-muted-foreground text-sm">
            Disciplinary records will appear here.
          </div>
        )}
      </div>
    </>
